    ...
    <div className="h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4 text-slate-300">
      ...
      >
        <div className="flex items-center gap-3">
          <Sparkles className="w-6 text-[#ffa500]" />
        ...
        <input
          ...
          type="file"
          accept="image/*"
          className="mt-2 w-full outline-none p-2 text-sm bg-gray-800 border border-gray-600 rounded-md text-white focus:outline-none focus:ring-2 focus:ring-orange-500"
          required
        />
        ...
        <button
          disabled={loading}
          className="mt-4 w-full bg-gradient-to-r from-[#ffa500] to-[#ff4500] text-white font-medium py-2 px-4 rounded-md transition duration-200 flex items-center justify-center gap-2"
        >
          {loading ? (
      ...
      <div className="w-full max-w-lg p-4 bg-black rounded-lg flex flex-col border border-gray-500 min-h-96">
        <div className="flex items-center gap-3">
          <Eraser className="w-6 h-5 text-[#ff4500]" />
        ...
        {!content ? (
          <div className="flex-1 flex justify-center items-center">
            <div className="text-sm flex flex-col items-center gap-5 text-gray-400">
              ...
              <p>
                Your processed image with the background removed will appear
                here.
              </p>
            </div>
          </div>
